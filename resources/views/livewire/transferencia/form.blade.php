                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" id="p{{$itemVenta['articulo']['ar_id']}}" wire:change="updatePrice({{$itemVenta['articulo']['ar_id']}}, parseFloat($('#p' +{{$itemVenta['articulo']['ar_id']}}).val()))"
                                                    style="font-size: 1rem!important"
                                                    class="form-control text-center"
                                                    value="{{ number_format($itemVenta['item']['it_pcos'], 2, '.', '') }}"
                                                    onclick="if(this.value=='{{ number_format($itemVenta['item']['it_pcos'], 2, '.', '') }}') this.value=''"
                                                >
                                            </td>
                                            <td class="text-center">
                                                <h6>
                                                    ${{number_format($itemVenta['item']['it_pcos'] * $itemVenta['item']['cant'],2, '.', ',')}}
                                                </h6>
                                            </td>
                                            <td class="text-center">
